(function(root,out){const version='2.0.0';function _classPrivateFieldGet(receiver,privateMap){var descriptor=privateMap.get(receiver);if(!descriptor){return undefined;}if(descriptor.get){return descriptor.get.call(receiver);}return descriptor.value;}
...
root.Dumper=Dumper;}(window,console));