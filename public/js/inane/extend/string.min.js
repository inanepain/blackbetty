...
if(!String.prototype.log){String.prototype.log=function(label=false){if(label?.constructor?.name==`String`)console.log(`${label}: `+this.toString());else if(label===true)console.log(`${this.constructor.name} (${this.length}): `+this.toString());else console.log(this.toString());return this.toString();};}