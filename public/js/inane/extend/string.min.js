if(!String.prototype.toTitleCase){String.prototype.toTitleCase=function(lowerAsWell=false,isName=false){let string=lowerAsWell===true?this.toLowerCase():this;if(isName)return string.replace(/\b[a-z]/g,txt=>{return txt.charAt(0).toUpperCase()+txt.substr(1).toLowerCase();});else return string.replace(/(?:^|\s)\w/g,function(match){return match.toUpperCase();});};}
...
if(!Date.prototype.log){String.prototype.log=function(){console.log(this.constructor.name+' ('+this.length+'): '+this.toString());return this.toString();};}